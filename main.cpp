...
int main() {
    ...
    std::list<Song> playlist{
         {"295" , "Sidhu Moose Wala" , 5},
        {"Massomiat" , "Satinder Sartaj" , 5},
        {"Akhar" , "Amrinder Gill" , 4},
        {"Believer" , "Imagine Dragons" , 3},
        {"Sher-E-Panjab" , "Arjan Dhillion" , 5},
        {"Akhiyan Udeek Diyan" , "Nusrat Fateh Ali Khan" , 5},
